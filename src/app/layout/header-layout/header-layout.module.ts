...
const routes: Routes = [
	{ path: '', component: HeaderLayoutComponent, children: [
		...
		{ path: 'signup', loadChildren: () => import('../../pages/registro/registro.module').then(m => m.RegistroModule) },		{ path: 'plans', loadChildren: () => import('../../pages/plans/plans.module').then(m => m.PlansModule) },
